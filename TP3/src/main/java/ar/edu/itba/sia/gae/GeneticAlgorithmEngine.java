...
public class GeneticAlgorithmEngine {
    ...
    public GeneticAlgorithmEngine(SelectionMethod selectionMethod, crossOver crossOverMethod, mutation mutationMethod, replacement replacementMethod, Map<ItemType, List<Item>> items) {
